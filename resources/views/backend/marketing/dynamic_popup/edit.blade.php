                    ...
                    <div class="row gutters-16">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="btn_link" value="{{ $dynamic_popup->btn_link }}" placeholder="{{ translate('Type your text here') }}" value="{{ $dynamic_popup->btn_link }}" required>
                                </div>
                            </div>
