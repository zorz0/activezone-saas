                                ...
                                <div class="pt-3 pt-lg-4 bg-white">
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="row mt-3">
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="wholesale" id="retail" value="0" checked>
                                                ...
                                                <div class="col">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="wholesale" id="wholesale" value="1">
                                            ...
                                            <div id="wholesaleInput" style="display: none;" class="mt-3">
                                                <label class="form-check-label" for="wholesale">
                                                    {{translate('Please upload your business registration document')}}
                                                </label>
                                                
                                                <input class="form-control" type="file" id="wholesaleFileId" name="wholesaleFile">
...
@section('script')
    ...
    <script type="text/javascript">
     ...
     $(document).ready(function(){
          $("#reg-form").on("submit", function(evt) {
            ...
            var userType = $('input[name="wholesale"]:checked').val();
            if (userType == 1) {
              var fileInput = document.getElementById('wholesaleFileId');
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            var wholesaleRadio = document.getElementById("wholesale");
            var wholesaleInput = document.getElementById("wholesaleInput");
            var retailRadio = document.getElementById("retail");

            wholesaleRadio.addEventListener("change", function () {
                if (wholesaleRadio.checked) {
                    wholesaleInput.style.display = "block";
                } else {
                    wholesaleInput.style.display = "none";
                }
            });
            retailRadio.addEventListener("change", function () {
                if (wholesaleRadio.checked) {
                    wholesaleInput.style.display = "block";
                } else {
                    wholesaleInput.style.display = "none";
