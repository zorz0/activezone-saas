...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::prefix('classified')->group(function () {
            ...
            Route::post('/store', 'App\Http\Controllers\Api\V2\CustomerProductController@store')->middleware('auth:sanctum');
            Route::post('/update/{id}', 'App\Http\Controllers\Api\V2\CustomerProductController@update')->middleware('auth:sanctum');
    ...
    Route::get('products/related/{slug}', 'App\Http\Controllers\Api\V2\ProductController@related')->name('products.related');
